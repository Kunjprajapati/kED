...
def apply_logic_FOR_dailyEV_CMD(file1_path, file2_path):
    try:
        ...
        resultant_data.loc[
            ...
            (resultant_data["Primary Insurance Name"] == "GET INSURANCE INFORMATION"), "Assigned Emp ID#"] = "Calling Account"

        # output_file_path = os.path.join(os.path.dirname(file2_path), f"ExcelAutomation.xlsx")
        output_dir = 'Results/DailyEV/CMD'
        ...
        kunjdate = parts[-1] 
        output_path = os.path.join(output_dir, f'CMD_EV_{kunjdate}.xlsx')
...
def classic_upgradation_dailyev(filtered_data):
    ...
    filtered_data["Provider Group NPI"] = 1902407752
...
# Patient Balance, Provider Group NPI