...
def function_for_Gastroenterology_Atlanta(pathing):
    ...
    output_dir = 'Results/DailyCharges/Gastroenterology_Atlanta'
    ...
    output_path = os.path.join(output_dir, f'Gastroenterology_Atlanta_Charges_of_{kunjdate}.xlsx')
