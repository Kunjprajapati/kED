...
def apply_logic_FOR_dailyEV_MAG(file1_path, file2_path):
    try:
        ...
        output_dir = 'Results/DailyEV/MAG'
        ...
        kunjdate = parts[-1]
        output_path = os.path.join(output_dir, f'MAG_EV_{kunjdate}.xlsx')
...
def classic_upgradation(filtered_data):
    ...
    filtered_data["Provider Group NPI"] = 1093096638
    ...
    filtered_data['Assigned Emp ID#'] = "RMM065"
