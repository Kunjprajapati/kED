...
# pathing = "SMP_charges_06.20.2024"
import warnings
warnings.filterwarnings('ignore', category=pd.errors.SettingWithCopyWarning)
warnings.filterwarnings('ignore', category=FutureWarning)  

def function_for_SMP(pathing):
    ...
    resultant["Provider Name"] = resultant["Provider Name"].fillna("SOTOMAYOR_M")
    ...
    output_dir = 'Results/DailyCharges/SMP'
    ...
    output_path = os.path.join(output_dir, f"SMP_charges_of_{kunjdate}.xlsx")
