...
def apply_logic_FOR_dailyEV_HealthFirst(file1_path, file2_path):
    try:
        ...
        # To Insert the data as "Human" in the section where the insurance is said to be the following......
        ...
        output_dir = 'Results/DailyEV/Health_First'
        ...
        kunjdate = parts[-1] 
        output_path = os.path.join(output_dir, f'Healthfirst_EV_{kunjdate}.xlsx')
...
def classic_upgradation(filtered_data):
    ...
    filtered_data["Provider Group NPI"] = 1609218098
